...
sr.reveal('.section__subtitle', {delay: 200, origin: 'left'})
sr.reveal('.skills__content', {origin: 'bottom', delay: 200})
sr.reveal('.services__card', {origin: 'bottom', delay: 200})
sr.reveal('.work__filters', {delay: 200})
sr.reveal('.work__card', {origin: 'bottom', delay: 200})
sr.reveal('.education__container', {origin: 'bottom', delay: 200})
sr.reveal('.contact__container', {origin: 'bottom', delay: 200})